...
from Utils.functions import login_to_enrollware_and_navigate_to_instructor_records
from automation.Utils.functions import clean_username
...
def main():
    ...
    try:
        ...
        for instructor_url, instructor_username in zip(all_instructors_urls, all_instructors_usernames):
            ...
            name = clean_username(instructor_username.text.strip())
        ...
        for user_url, username in instructors_info:
            try:
                ...
                no_record_found = check_element_exists(processor.driver, no_record_selector, timeout=3)
                if no_record_found:
                ...
                for record_element in all_records_elements:
                    ...
                    if record_url:
                        ...
                        if not link:
                            ...
                            continue
                        file_url = get_element_attribute(processor, link_selector, "href")
                        file_name = get_element_text(processor, link_selector, timeout=3)
